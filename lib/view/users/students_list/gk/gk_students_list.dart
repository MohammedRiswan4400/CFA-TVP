...
class ScreenGkList extends StatelessWidget {
  const ScreenGkList({super.key});
  ...
  Stream<List<ModelGK>> readGkStudents() => FirebaseFirestore.instance
      .collection("CFC")
      .doc("Students")
      .collection("GK")
      .snapshots()
