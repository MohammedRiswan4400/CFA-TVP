...
class ScreenUnder13 extends StatelessWidget {
  const ScreenUnder13({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Under 13"),
        centerTitle: true,
      ),
      body: Column(
                  ...
                  if (students!.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Under13SlidableWidget(student: student);
                        //  buildWidget(student: student);
                      },
                    );
                  }
                }
  ...
  Stream<List<ModelStudents>> readUnder13() => FirebaseFirestore.instance
      .collection("CFC")
      .doc("Students")
      .collection("Under 13")
      .snapshots()
...
class Under13SlidableWidget extends StatelessWidget {
  const Under13SlidableWidget({
    super.key,
