...
class ScreenUnder15 extends StatelessWidget {
  const ScreenUnder15({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Under 15"),
        centerTitle: true,
      ),
      body: Column(
                  ...
                  if (students!.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Under15SlidableWidget(student: student);
                      },
                    );
                  }
                }
  ...
  Stream<List<ModelStudents>> readUnder15Students() =>
...
class Under15SlidableWidget extends StatelessWidget {
  const Under15SlidableWidget({
    super.key,
