...
import 'package:trappra_chat/view/admin/players/edit_student/edit_gk.dart';

import '../../../../controller/goto_admin.dart';

class ScreenGK extends StatelessWidget {
  const ScreenGK({super.key});
                  ...
                  if (students!.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SlidableWidget(student: student);
                      },
                    );
                  }
                }
  ...
  Stream<List<ModelGK>> readGK() => FirebaseFirestore.instance
      .collection("CFC")
      .doc("Students")
      .collection("GK")
      .snapshots()
