...
class ScreenUnder18 extends StatelessWidget {
  const ScreenUnder18({super.key});
                  ...
                  if (students!.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Under18SlidableWidget(student: student);
  ...
  Stream<List<ModelStudents>> readUnder18() => FirebaseFirestore.instance
      .collection("CFC")
      .doc("Students")
      .collection("Under 18")
      .snapshots()
...
class Under18SlidableWidget extends StatelessWidget {
  const Under18SlidableWidget({
    super.key,
