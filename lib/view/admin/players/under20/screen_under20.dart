...
class ScreenUnder20 extends StatelessWidget {
                  ...
                  if (students!.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Under20SlidableWidget(student: student);
                      },
                    );
                  }
                }
  ...
  Stream<List<ModelStudents>> readUnder20Students() =>
...
class Under20SlidableWidget extends StatelessWidget {
  const Under20SlidableWidget({
    super.key,
